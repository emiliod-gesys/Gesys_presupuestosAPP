  ...
  return (
    <Card>
      <CardContent className="pt-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-6">Crear cuenta gratuita</h2>

        <Button variant="outline" className="w-full mb-4" onClick={handleGoogle} loading={googleLoading}>
